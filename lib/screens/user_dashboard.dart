        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Wallet Address : ' + userInfo[0].toString()),
              Text('Name : ' + userInfo[1].toString()),
              Text('Age : ' + userInfo[2].toString()),
              Text('City : ' + userInfo[3].toString()),
              Text('Aadhar Number : ' + userInfo[4].toString()),
              Text('Pan : ' + userInfo[5].toString()),
              Text('Email : ' + userInfo[7].toString()),
